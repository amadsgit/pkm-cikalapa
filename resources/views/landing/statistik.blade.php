...
<head>
    ...
    <meta name="csrf-token" content="xpEHDwP3CiRtk2zuanYt6i2Wr5IzA6YSFSxCcp1Y">

    <!-- SEO Tags -->
    <title>Puskesmas Cikalapa - Statistik  Puskesmas Cikalapa</title>
    <meta name="description" content="Website Resmi  Puskesmas Cikalapa - Informasi dan layanan  dalam genggaman">
    <meta name="keywords"
        content=" digital, pemerintahan , Puskesmas Cikalapa, layanan , berita , UMKM ">
    <meta name="author" content="Puskesmas Cikalapa">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://alamatweb/statistik">
    <meta property="og:title" content="Puskesmas Cikalapa - Statistik  Puskesmas Cikalapa">
    <meta property="og:description"
        content="Website Resmi  Puskesmas Cikalapa - Informasi dan layanan  dalam genggaman">
    <meta property="og:image" content="/storage/uploads//logo/01JSG2CCXM0VYXQYTTZNT9NQNB.png">

    <!-- Twitter -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Puskesmas Cikalapa - Statistik  Puskesmas Cikalapa">
    <meta name="twitter:description"
        content="Website Resmi  Puskesmas Cikalapa - Informasi dan layanan  dalam genggaman">
    <meta name="twitter:image" content="/storage/uploads//logo/01JSG2CCXM0VYXQYTTZNT9NQNB.png">

    <!-- Favicon -->
    <link rel="icon" href="https://alamatweb/favicon.ico" type="image/x-icon" />
    <link rel="apple-touch-icon" sizes="180x180" href="https://alamatweb/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="https://alamatweb/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="https://alamatweb/favicon-16x16.png">
    ...
    <!-- Scripts & Styles -->
    <link rel="stylesheet" href="https://alamatweb/build/assets/app-BaP_ecyO.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <script src="https://alamatweb/build/assets/app-DuLuyI5i.js" defer></script>
...
<body class="font-sans antialiased bg-gray-50">
      ...
      toggleMobileMenu() { this.mobileMenuOpen = !this.mobileMenuOpen } }"
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center">
                            <a href="https://alamatweb"
                                class="flex items-center transition-transform hover:-translate-y-0.5 duration-200">
                                <img src="/storage/uploads//logo/01JSG2CCXM0VYXQYTTZNT9NQNB.png"
                                    alt="Puskesmas Cikalapa" class="h-10 w-auto object-contain">
                            </a>
                        </div>
                        ...
                        <div class="hidden lg:flex lg:items-center">
                            <div class="flex items-center space-x-6 mr-8">
                                ...
                                <a href="https://alamatweb/layanan"
                                    class="flex items-center space-x-1.5 text-sm font-medium group">
                                    <span class="text-emerald-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <a href="https://alamatweb/statistik"
                                    class="flex items-center space-x-1.5 text-sm font-medium group">
                                    <span class="text-emerald-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span
                                        class="py-2 px-1 border-b-2 border-emerald-500 text-emerald-600 font-semibold transition duration-200">
                                        Statistik
                                    </span>
                                </a>
                            </div>
                            ...
                            <div class="flex items-center border-l border-gray-200 pl-6 ml-6 space-x-4">
                                ...
                                <a href="https://alamatweb/register"
        ...
        <main class="flex-grow bg-white">
            ...
            <section class="pt-12 pb-16 bg-gradient-to-br from-emerald-600 to-emerald-900 relative overflow-hidden">
                ...
                <div
                    class="absolute bottom-0 right-0 w-96 h-96 bg-white opacity-5 rounded-full translate-x-1/3 translate-y-1/3">
                </div>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div class="text-center">
                        ...
                        <div class="relative inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-emerald-600/30 to-emerald-700/30 backdrop-blur-lg border border-white/30 shadow-xl group overflow-hidden cursor-pointer"
                            ...
                            <span
                                class="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-all duration-1000 ease-in-out"></span>
                        ...
                        <h1 class="mt-4 text-3xl md:text-4xl lg:text-5xl font-bold text-white group" data-aos="fade-up">
                            <span class="relative inline-block">
                                Statistik Puskesmas Cikalapa
                                <span
                                    class="absolute bottom-0 left-0 w-full h-0.5 bg-emerald-300 scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></span>
                            </span>
                        </h1>

                        <!-- Description with Fade In Effect -->
                        <p class="mt-4 max-w-2xl mx-auto text-emerald-50 text-lg opacity-90" data-aos="fade-up"
                            data-aos-delay="100">
                            Data dan perkembangan  dalam bentuk visualisasi yang informatif
                        </p>
                    </div>
                </div>
    ...
    initTabs() {
        ...
        tabButtons.forEach(button => {
                ...
                <div class="max-w-7xl pt-4 mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mb-0">
                        ...
                        <p class="text-gray-600 text-sm md:text-base w-full mb-3">
                            Pilih kategori data untuk melihat statistik  dalam berbagai aspek
                        </p>
                    </div>
                        ...
                        <div x-ref="tabSlider"
                            ...
                            <div class="inline-flex gap-2 min-w-full px-1 py-1" data-aos="fade-up">
                                ...
                                <button type="button" id="tab-inventaris"
                                    ...
                                    <i class="fas fa-boxes mr-1.5 text-xs"></i> Inventaris 
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <section class="pb-10">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div id="section-kependudukan" class="tab-content">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
                            <!-- Total Penduduk Card -->
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5 flex items-start"
                                data-aos="fade-up">
                                <div
                                    class="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-emerald-100 mr-4">
                                    <i class="fas fa-users text-xl text-emerald-500"></i>
                                </div>
                                <div>
                                    <h3 class="text-sm font-medium text-gray-500">Total Penduduk</h3>
                                    <div class="text-2xl font-bold text-emerald-500 mt-1">77</div>
                                    <p class="text-xs text-gray-500 mt-1">Jumlah warga terdaftar di </p>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5 flex items-start"
                                ...
                                <div
                                    class="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-indigo-100 mr-4">
                                    <i class="fas fa-venus-mars text-xl text-indigo-600"></i>
                                </div>
                                <div>
                                    <h3 class="text-sm font-medium text-gray-500">Rasio Gender</h3>
                                    <div class="text-2xl font-bold mt-1">
                                        <span class="text-indigo-600">49%</span>
                                        <span class="text-gray-400 mx-1">:</span>
                                        <span class="text-pink-500">51%</span>
                                    </div>
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5 flex items-start"
                                ...
                                <div
                                    class="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-orange-100 mr-4">
                                    <i class="fas fa-home text-xl text-orange-500"></i>
                                </div>
                                <div>
                                    <h3 class="text-sm font-medium text-gray-500">Kepala Keluarga</h3>
                                    <div class="text-2xl font-bold text-orange-500 mt-1">16</div>
                                    <p class="text-xs text-gray-500 mt-1">Total KK terdaftar di </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-4 sm:p-5"
                                data-aos="fade-up">
                    ...
                    <div id="section-keuangan" class="tab-content hidden">
                        ...
                        <div class="flex justify-between items-center mb-3 gap-3">
                            <p class="text-gray-600 text-sm md:text-base truncate max-w-[60%] sm:max-w-[70%]">
                                Statistik keuangan <span class="hidden sm:inline"> dalam berbagai periode</span>
                            </p>

                            <!-- Modern Dropdown Filter -->
                            <div class="relative shrink-0" x-data="{ open: false }">
                                <button @click="open = !open"
                                    class="bg-white border border-gray-200 px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-lg shadow-sm flex items-center gap-1.5 sm:gap-2 hover:bg-gray-50 transition-colors">
                                    <i class="fas fa-filter text-emerald-500"></i>
                                    <span id="selected-periode" class="text-sm md:text-base whitespace-nowrap">Semua
                                        Waktu</span>
                                ...
                                <div x-show="open" @click.away="open = false" x-ref="dropdown"
                                    class="absolute right-0 mt-2 bg-white rounded-lg shadow-lg z-50 border border-gray-100 overflow-hidden min-w-[200px] w-full md:w-auto">
                                    <div id="periode-filters" class="max-h-[70vh] overflow-y-auto">
                                        <button type="button"
                                            class="periode-btn active w-full text-left px-4 py-2.5 text-sm md:text-base hover:bg-emerald-50 flex items-center gap-2.5"
                                            data-periode="semua_waktu" @click="open = false">
                                            <i class="fas fa-calendar text-emerald-500 w-4"></i> Semua Waktu
                                        </button>
                                        <button type="button"
                                            class="periode-btn w-full text-left px-4 py-2.5 text-sm md:text-base hover:bg-emerald-50 flex items-center gap-2.5"
                                            data-periode="tahun_ini" @click="open = false">
                                            <i class="fas fa-calendar-alt text-emerald-500 w-4"></i> Tahun Ini
                                        </button>
                                        <button type="button"
                                            class="periode-btn w-full text-left px-4 py-2.5 text-sm md:text-base hover:bg-emerald-50 flex items-center gap-2.5"
                                            data-periode="bulan_ini" @click="open = false">
                                            <i class="fas fa-calendar-day text-emerald-500 w-4"></i> Bulan Ini
                                        </button>
                                        <button type="button"
                                            class="periode-btn w-full text-left px-4 py-2.5 text-sm md:text-base hover:bg-emerald-50 flex items-center gap-2.5"
                                            data-periode="minggu_ini" @click="open = false">
                                            <i class="fas fa-calendar-week text-emerald-500 w-4"></i> Minggu Ini
                                        </button>
                                        <button type="button"
                                            class="periode-btn w-full text-left px-4 py-2.5 text-sm md:text-base hover:bg-emerald-50 flex items-center gap-2.5"
                                            data-periode="tahun_lalu" @click="open = false">
                                            <i class="fas fa-history text-emerald-500 w-4"></i> Tahun Lalu
                                        </button>
                                        <button type="button"
                                            class="periode-btn w-full text-left px-4 py-2.5 text-sm md:text-base hover:bg-emerald-50 flex items-center gap-2.5"
                                            data-periode="bulan_lalu" @click="open = false">
                                            <i class="fas fa-history text-emerald-500 w-4"></i> Bulan Lalu
                                        </button>
                                        <div class="border-t border-gray-100"></div>
                                        <button type="button"
                                            class="periode-btn w-full text-left px-4 py-2.5 text-sm md:text-base hover:bg-emerald-50 flex items-center gap-2.5"
                                            data-periode="kustom" id="btn-kustom" @click="open = false">
                        ...
                        <div id="date-range-picker"
                            class="hidden mb-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-3">
                                <div class="sm:col-span-1 lg:col-span-3">
                                    <label for="dari-tanggal"
                                        class="block text-sm md:text-base font-medium text-gray-700 mb-1">Dari
                                        Tanggal</label>
                                    <input type="date" id="dari-tanggal"
                                        class="w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm md:text-base">
                                </div>
                                <div class="sm:col-span-1 lg:col-span-3">
                                    <label for="sampai-tanggal"
                                        class="block text-sm md:text-base font-medium text-gray-700 mb-1">Sampai
                                        Tanggal</label>
                                    <input type="date" id="sampai-tanggal"
                                        class="w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm md:text-base">
                                </div>
                                <div class="sm:col-span-2 lg:col-span-1 flex items-end">
                                    <button type="button" id="terapkan-filter"
                                        class="w-full px-3 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition flex items-center justify-center text-sm md:text-base">
                        ...
                        <!-- Info Period Label -->
                        <p class="text-gray-700 mb-6 text-sm md:text-base" id="periode-info">Menampilkan data keuangan
                            untuk periode <span class="font-semibold">Semua Waktu</span></p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8" id="keuangan-stats-container">
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5" data-aos="fade-up">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-500 text-xs md:text-sm mt-0.5">Seluruh pemasukan </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5" data-aos="fade-up">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-500 text-xs md:text-sm mt-0.5">Seluruh pengeluaran </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Saldo Card -->
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5" data-aos="fade-up">
                                <h3 class="text-gray-500 text-sm md:text-base font-medium mb-2">Saldo </h3>
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10 rounded-full flex items-center justify-center mr-3"
                                    ...
                                    <div>
                                        <div class="text-2xl font-bold text-blue-500" id="saldo-">Rp 0</div>
                                        <p class="text-gray-500 text-xs md:text-sm mt-0.5" id="periode-text">Saldo
                                            keuangan</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="bg-white rounded-lg p-4 shadow-sm border border-green-100">
                                        <h4
                                            class="font-medium text-emerald-600 mb-2 flex items-center text-sm md:text-base">
                                            <i class="fas fa-arrow-up text-emerald-600 mr-2"></i> Transaksi Pemasukan
                                            Terbesar
                                        </h4>
                                    ...
                                    <div class="bg-white rounded-lg p-4 shadow-sm border border-red-100">
                                        <h4
                                            class="font-medium text-red-600 mb-2 flex items-center text-sm md:text-base">
                                            <i class="fas fa-arrow-down text-red-600 mr-2"></i> Transaksi Pengeluaran
                                            Terbesar
                                        </h4>
                        ...
                        <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100" data-aos="fade-up">
                            <div class="p-4">
                                <div class="flex items-center mb-4">
                                    ...
                                    <h3 class="text-sm md:text-base font-medium text-gray-800">
                                        <i class="fas fa-chart-line text-emerald-600 mr-2"></i> Ringkasan Status
                                        Keuangan
                                    </h3>
                                </div>
                                ...
                                <div class="flex flex-col gap-3" id="status-keuangan">
                                    ...
                                    <div id="saldo-status-container"
                                        class="p-3 bg-white rounded-lg border border-red-100 flex items-start">
                                        <i id="saldo-icon" class="fas fa-info-circle text-red-500 mt-0.5 mr-2.5"></i>
                                        <span id="saldo-status"
                                            class="block text-red-800 font-medium text-sm md:text-base">Menghitung
                                            status keuangan...</span>
                                    </div>

                                    <!-- Trend status - akan berubah warna berdasarkan kondisi -->
                                    <div id="trend-status-container"
                                        class="p-3 bg-white rounded-lg border border-red-100 flex items-start">
                                        <i id="trend-icon" class="fas fa-chart-line text-red-500 mt-0.5 mr-2.5"></i>
                                        <span id="trend-status"
                                            class="block text-red-800 text-sm md:text-base">Menganalisis tren
                                            keuangan...</span>
                                    </div>
                                </div>
                            </div>
                ...
                // Pantau perubahan pada nilai saldo 
                ...
                document.querySelectorAll('.periode-btn').forEach(button => {
                    ...
                    <div id="section-bansos" class="tab-content hidden">
                        ...
                        <div class="flex justify-between items-center mb-3 gap-3">
                            ...
                            <div class="relative shrink-0" x-data="{ open: false }">
                                <button @click="open = !open"
                                    class="bg-white border border-gray-200 px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-lg shadow-sm flex items-center gap-1.5 sm:gap-2 hover:bg-gray-50 transition-colors">
                                    <i class="fas fa-filter text-emerald-500"></i>
                                    <span id="bansos-selected-periode"
                                        class="text-sm md:text-base whitespace-nowrap">Semua Waktu</span>
                                    <i class="fas fa-chevron-down text-gray-400 ml-1 sm:ml-2"></i>
                                </button>
                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <div id="bansos-periode-filters" class="max-h-[70vh] overflow-y-auto">
                                        ...
                                        <button type="button"
                                            class="periode-btn w-full text-left px-4 py-2.5 text-sm md:text-base hover:bg-emerald-50 flex items-center gap-2.5"
                                            data-periode="kustom" id="bansos-btn-kustom" @click="open = false">
                                            <i class="fas fa-calendar-plus text-emerald-500 w-4"></i> Kustom
                                        </button>
                                    </div>
                                </div>
                        ...
                        <!-- Custom Date Range - Modern UI -->
                        <div id="bansos-date-range-picker"
                            class="hidden mb-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-3">
                                <div class="sm:col-span-1 lg:col-span-3">
                                    <label for="bansos-dari-tanggal"
                                        class="block text-sm md:text-base font-medium text-gray-700 mb-1">Dari
                                        Tanggal</label>
                                    <input type="date" id="bansos-dari-tanggal"
                                        class="w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm md:text-base">
                                </div>
                                <div class="sm:col-span-1 lg:col-span-3">
                                    <label for="bansos-sampai-tanggal"
                                        class="block text-sm md:text-base font-medium text-gray-700 mb-1">Sampai
                                        Tanggal</label>
                                    <input type="date" id="bansos-sampai-tanggal"
                                        class="w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm md:text-base">
                                </div>
                                <div class="sm:col-span-2 lg:col-span-1 flex items-end">
                                    <button type="button" id="bansos-terapkan-filter"
                                        class="w-full px-3 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition flex items-center justify-center text-sm md:text-base">
                                        <i class="fas fa-check mr-1.5"></i> Terapkan
                                    </button>
                                </div>
                        ...
                        <p class="text-gray-700 mb-6 text-sm md:text-base">Menampilkan data bantuan sosial untuk periode
                            <span class="font-semibold" id="bansos-periode-display">Semua Waktu</span></p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5" data-aos="fade-up"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <div class="text-2xl font-bold text-orange-500" id="total-prioritas-tinggi">0
                                        </div>
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5" data-aos="fade-up"
                                data-aos-delay="200">
                                <h3 class="text-gray-500 text-sm md:text-base font-medium mb-2">Persentase Persetujuan
                                </h3>
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10 rounded-full flex items-center justify-center mr-3"
                                    ...
                                    <div>
                                        <div class="text-2xl font-bold text-indigo-500" id="persentase-persetujuan">0%
                                        </div>
                                        <p class="text-gray-500 text-xs md:text-sm mt-0.5">Tingkat persetujuan bantuan
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Chart with Filter -->
                        <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-4 sm:p-5 mb-6"
                            data-aos="fade-up">
                            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                                <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-0"><i
                                        class="fas fa-chart-pie mr-2 text-emerald-600"></i> Grafik Bantuan Sosial</h3>
                                <div class="self-end md:self-auto">
                                    <select id="bansos-chart-filter"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 p-2.5">
                            ...
                            <div class="relative overflow-hidden rounded-lg bg-white shadow-inner p-3">
                                <div id="bansos-chart" class="w-full h-[300px] xs:h-[320px] sm:h-[350px] md:h-[400px]">
                                </div>
                            </div>
                        </div>
                ...
                document.getElementById('bansos-terapkan-filter').addEventListener('click', function() {
                    ...
                    <div id="section-inventaris" class="tab-content hidden">
                        ...
                        <!-- Stats Overview -->
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8"
                            id="inventaris-stats-container">
                            <!-- Total Inventaris Card -->
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5 flex items-start"
                                data-aos="fade-up">
                                <div
                                    class="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-blue-100 mr-4">
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5 flex items-start"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Nilai aset inventaris </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5 flex items-start"
                                data-aos="fade-up" data-aos-delay="100">
                                <div
                                    class="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-amber-100 mr-4">
                                    <i class="fas fa-exclamation-triangle text-xl text-amber-500"></i>
                                </div>
                                <div>
                                    <h3 class="text-sm font-medium text-gray-500">Rusak Ringan</h3>
                                    <div class="text-2xl font-bold text-amber-500 mt-1" id="kondisi-rusak-ringan">0
                                    </div>
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5 flex items-start"
                                data-aos="fade-up" data-aos-delay="200">
                                <div
                                    class="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-red-100 mr-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5 flex items-start"
                                data-aos="fade-up" data-aos-delay="100">
                                <div
                                    class="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-purple-100 mr-4">
                            ...
                            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-5 flex items-start"
                                data-aos="fade-up" data-aos-delay="200">
                                <div
                                    class="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-yellow-100 mr-4">
                                    <i class="fas fa-tools text-xl text-yellow-600"></i>
                                </div>
                                <div>
                                    <h3 class="text-sm font-medium text-gray-500">Dalam Perbaikan</h3>
                                    <div class="text-2xl font-bold text-yellow-600 mt-1" id="status-dalam-perbaikan">0
                                    </div>
            ...
            <footer class="bg-gradient-to-b from-gray-50 to-gray-100 border-t border-gray-200">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    <button id="back-to-top"
                        class="absolute -top-5 right-8 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full p-3 shadow-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-emerald-400">
                ...
                <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <!-- Kolom 1: Tentang  (larger size) -->
                        <div class="md:col-span-1 lg:col-span-1">
                            <h3
                                class="text-sm font-semibold text-gray-600 tracking-wider uppercase relative inline-block after:absolute after:w-1/2 after:h-0.5 after:bg-emerald-500 after:bottom-0 after:left-0 pb-1">
                                Tentang 
                            </h3>
                            <div class="mt-5">
                                <img src="/storage/uploads//logo/01JSG2CCXM0VYXQYTTZNT9NQNB.png"
                                    alt="Puskesmas Cikalapa" class="h-16 w-auto mb-4 object-contain">
                                ...
                                <p class="mt-3 text-sm text-gray-500 flex items-center group">
                                    <span
                                        class="flex items-center justify-center bg-emerald-100 text-emerald-500 h-8 w-8 rounded-full mr-3 group-hover:bg-emerald-500 group-hover:text-white transition duration-300">
                                        <i class="fas fa-phone-alt"></i>
                                    </span>
                                    <span
                                        class="group-hover:text-emerald-600 transition duration-300">0234-5678901</span>
                                </p>
                                <p class="mt-2 text-sm text-gray-500 flex items-center group">
                                    ...
                                    <span
                                        class="group-hover:text-emerald-600 transition duration-300">-kedungwungu@indramayu..id</span>
                                </p>
                        ...
                        <div>
                            ...
                            <ul class="mt-5 space-y-3">
                                <li>
                                    <a href="https://alamatweb"
                                        class="text-base text-gray-600 hover:text-emerald-600 flex items-center transition duration-300 group">
                                        <span
                                            class="w-2 h-2 bg-emerald-400 rounded-full mr-2 group-hover:w-3 transition-all duration-300"></span>
                                        Beranda
                                    </a>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul class="mt-5 space-y-3">
                                ...
                                <li>
                                    <a href="https://alamatweb/layanan/21"
                                        class="text-base text-gray-600 hover:text-emerald-600 flex items-center transition duration-300 group">
                                        <span
                                            class="w-2 h-2 bg-emerald-400 rounded-full mr-2 group-hover:w-3 transition-all duration-300"></span>
                                ...
                                <li>
                                    <a href="https://alamatweb/layanan/23"
                                        class="text-base text-gray-600 hover:text-emerald-600 flex items-center transition duration-300 group">
                                        <span
                                            class="w-2 h-2 bg-emerald-400 rounded-full mr-2 group-hover:w-3 transition-all duration-300"></span>
                                        Program PKH
                                ...
                                <li>
                                    <a href="https://alamatweb/layanan/22"
                                        class="text-base text-gray-600 hover:text-emerald-600 flex items-center transition duration-300 group">
                                        <span
                                            class="w-2 h-2 bg-emerald-400 rounded-full mr-2 group-hover:w-3 transition-all duration-300"></span>
                                        Bimbingan Belajar
                                ...
                                <li>
                                    <a href="https://alamatweb/layanan/28"
                                        class="text-base text-gray-600 hover:text-emerald-600 flex items-center transition duration-300 group">
                                        <span
                                            class="w-2 h-2 bg-emerald-400 rounded-full mr-2 group-hover:w-3 transition-all duration-300"></span>
                                        Legalisasi Dokumen
                                ...
                                <li>
                                    <a href="https://alamatweb/layanan/20"
                                        class="text-base text-gray-600 hover:text-emerald-600 flex items-center transition duration-300 group">
                                        <span
                                            class="w-2 h-2 bg-emerald-400 rounded-full mr-2 group-hover:w-3 transition-all duration-300"></span>
                                        Kursus Komputer
                    ...
                    <div class="mt-12 pt-8 border-t border-gray-200">
                        <div class="flex flex-col md:flex-row md:justify-between items-center">
                            <p class="text-sm text-gray-500 mb-4 md:mb-0">
                                &copy; 2025 Puskesmas Cikalapa. Hak Cipta Dilindungi.
                            </p>
    ...
    if (document.getElementById('age-chart')) {
        ...
        const ageChartOptions = {
            ...
            xaxis: {
                categories: ["Balita (0-5)","Anak (6-12)","Remaja (13-18)","Dewasa Muda (19-30)","Dewasa (31-45)","Paruh Baya (46-60)","Lansia (\u003E60)"],
                labels: {
                    style: {
                        fontSize: '13px',
                        fontFamily: 'Inter, sans-serif',
    ...
    if (document.getElementById('occupation-chart')) {
        const occupationChartOptions = {
            ...
            labels: ["Guru","Petani","Dokter","Karyawan Swasta","Ibu Rumah Tangga","Nelayan"],
            legend: {
                position: 'bottom',
                fontSize: '14px',
                offsetY: 5,
    ...
    if (document.getElementById('section-keuangan')) {
        ...
        function updateStats(data) {
            ...
            document.getElementById('saldo-').textContent = 'Rp ' + new Intl.NumberFormat('id-ID').format(data.overview.saldo);
            ...
            // Update saldo status
            const saldoStatus = document.getElementById('saldo-status');
            if (data.overview.saldo > 0) {
                saldoStatus.textContent = 'Kondisi keuangan  dalam keadaan surplus sebesar ' + 'Rp ' + new Intl.NumberFormat('id-ID').format(data.overview.saldo);
            ...
            } else if (data.overview.saldo < 0) {
                saldoStatus.textContent = 'Kondisi keuangan  dalam keadaan defisit sebesar ' + 'Rp ' + new Intl.NumberFormat('id-ID').format(Math.abs(data.overview.saldo));
                ...
                saldoStatus.textContent = 'Kondisi keuangan  dalam keadaan seimbang';
