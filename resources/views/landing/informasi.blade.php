        ...
        <main class="flex-grow bg-white">
            <section class="pt-12 pb-16 bg-gradient-to-br from-emerald-600 via-teal-600 to-sky-700 relative overflow-hidden">
                ...
                <div class="absolute inset-0 overflow-hidden pointer-events-none">
                    <!-- Small floating dots -->
                    <span class="absolute w-2 h-2 bg-white/20 rounded-full animate-float"
                        style="top:10%; left:15%; animation-delay:0s;"></span>
                    <span class="absolute w-2.5 h-2.5 bg-emerald-300/40 rounded-full animate-float-slow"
                        style="top:25%; left:60%; animation-delay:2s;"></span>
                    <span class="absolute w-2.5 h-2.5 bg-sky-300/40 rounded-full animate-float"
                        style="top:40%; left:80%; animation-delay:1s;"></span>
                    <span class="absolute w-2 h-2 bg-teal-300/30 rounded-full animate-float-slow"
                        style="top:70%; left:35%; animation-delay:3s;"></span>
                    <span class="absolute w-4.5 h-4.5 bg-white/20 rounded-full animate-float"
                        style="top:85%; left:75%; animation-delay:1.5s;"></span>
                </div>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <div class="relative inline-flex items-center px-4 py-2 rounded-full 
                        ...
                        <!-- Moving Light Effect -->
                        <span class="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent 
                    ...
                    <p class="mt-3 text-base md:text-lg text-emerald-50 max-w-3xl mx-auto leading-relaxed" data-aos="fade-up"
                        data-aos-delay="100">
                        Informasi terkini seputar berita, artikel, edukasi dan pengumunan puskesmas.
                    </p>
                </div>
            ...
            <section class="pb-3 bg-white shadow-sm" id="informasi-list" x-data="{
                ...
                <div class="max-w-7xl pt-4 mx-auto px-4 sm:px-6 lg:px-8">
                    <!-- Modern Header: Informasi Terkini -->
                    <div class="mb-8 relative overflow-hidden rounded-2xl bg-gradient-to-r from-sky-50 via-white to-emerald-50 border border-emerald-100 shadow-sm hover:shadow-md transition-all duration-500 backdrop-blur-sm"
                        data-aos="fade-up">
                        <!-- Accent strip -->
                        <div
                            class="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-sky-400 via-emerald-400 to-teal-500 rounded-l-2xl">
                        </div>
                        ...
                        <div class="pl-5 pr-6 py-5 relative z-10">
                            <div class="flex items-center justify-between mb-2">
                                <div class="flex items-center space-x-2">
                                    <span
                                        class="inline-flex items-center bg-gradient-to-r from-sky-500 to-emerald-500 text-white text-xs sm:text-sm font-semibold px-3 py-1.5 rounded-full shadow-md">
                                        <i class="fas fa-newspaper mr-1.5 text-white/90"></i>
                                        INFORMASI TERKINI
                                    </span>
                                </div>
                    
                                <!-- Optional animated icon -->
                                <div class="hidden sm:block text-sky-400/70">
                                    <i class="fas fa-bullhorn text-lg animate-pulse"></i>
                                </div>
                            </div>
                    
                            <p class="text-gray-700 text-sm md:text-base leading-relaxed pl-1 dark:text-gray-700">
                                Dapatkan update berita dan informasi terbaru seputar berita, artikel kesehatan dan pengumuman puskesmas.
                            </p>
                    
                            <div class="mt-3 h-0.5 w-24 bg-gradient-to-r from-sky-400 via-emerald-400 to-teal-500 rounded-full"></div>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        <div x-ref="categorySlider" class="overflow-x-auto py-2 scrollbar-hide cursor-grab active:cursor-grabbing"
                            ...
                            <div class="inline-flex gap-2 min-w-full px-1 py-1">
                                ...
                                <a href="{{ url('informasi?kategori='.$category->slug) }}"
            ...
            <!-- Informasi Terbaru with Modern Cards - White Background -->
                        ...
                        <div class="group bg-white rounded-2xl shadow-sm overflow-hidden h-full flex flex-col transition-all duration-300 hover:shadow-lg relative border border-gray-100"
                            ...
                            <div class="relative aspect-w-16 aspect-h-9 overflow-hidden">
                                <img class="object-cover w-full h-full transition-transform duration-700 group-hover:scale-105"
                                    src="{{ $item->gambar ? asset('storage/'.$item->gambar) : asset('storage/uploads/informasi/default-announcement.jpg') }}"
                            ...
                            <div class="p-6 flex flex-col flex-grow relative bg-gray-50">
                                ...
                                <div class="mt-1 relative z-10">
                                    <p
                                        class="text-gray-600 text-sm leading-relaxed mb-5 pl-3 border-l-2 border-emerald-200 line-clamp-2">
                                        {{ $item->deskripsi }}
                                    </p>
                                </div>
