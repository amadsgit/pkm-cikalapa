...
<div x-data="{
    ...
    <section class="py-3 bg-white shadow-sm border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex gap-3 overflow-x-auto scrollbar-hide">
                ...
                <button @click="setActiveTab('daftar-informasi')" :class="activeTab === 'daftar-informasi'
                ...
                <!-- Tab: Tambah Informasi -->
                <button @click="setActiveTab('tambah-informasi')" :class="activeTab === 'tambah-informasi'
                        ? 'bg-emerald-500 text-white'
                        : 'bg-gray-100 text-gray-600'"
                    class="px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2">
    ...
    <div class="p-6 bg-white rounded-xl shadow-lg space-y-6 mt-4">
        ...
        <div class="mt-6 space-y-6">
            ...
            <!-- TAB: Informasi Umum -->
            <div x-show="activeTab === 'daftar-informasi'" x-transition>
                <h2 class="text-xl font-semibold text-gray-700 mb-4 flex items-center gap-2">
                    <i class="ph ph-newspaper text-emerald-500"></i>
                    Daftar Informasi
                </h2>
            ...
            <!-- Tab: Tambah Informasi -->
            <div x-show="activeTab === 'tambah-informasi'" x-transition>
                ...
                <form action="{{ route('informasiPublik.store') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="judul" value="{{ old('judul') }}" placeholder="Masukkan judul informasi"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="5" placeholder="Tuliskan deskripsi informasi" class="mt-2 block w-full text-lg border border-blue-300 bg-gray-100 rounded-xl
                                px-4 py-3 shadow-sm placeholder:text-gray-400
