...
@section('title', 'Nominatif Kepegawaian')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    {{-- Navbar --}}
    <div class="flex flex-wrap gap-2 bg-white rounded-2xl shadow-sm p-2 mb-6">
        <a href="{{ route('admin.ketatausahaan.pegawai') }}" class="px-4 py-2 rounded-xl font-medium flex items-center gap-2 transition
        ...
        <a href="{{ route('ketatausahaan.pegawai.nominatif') }}" class="px-4 py-2 rounded-xl font-medium flex items-center gap-2 transition
        ...
        <a href="{{ route('ketatausahaan.pegawai.duk') }}" class="px-4 py-2 rounded-xl font-medium flex items-center gap-2 transition
    ...
    <div class="bg-white shadow-sm rounded-2xl p-6">
        ...
        <div class="w-full h-[800px] lg:h-[1000px] border rounded-xl overflow-hidden shadow-inner">
            <iframe src="{{ route('nominatif.preview') }}" class="w-full h-full"></iframe>
        </div>
        @else
